...
<html>
 ...
 <form action="magazyn" method="get">
            ...
            <table>
                <tr>
                    <td class="naglowek"><a href="magazynzmien2?sort=0">Id</a></td>
                    <td class="naglowek"><a href="magazynzmien2?sort=1">Nazwa</a></td>
                    <td class="naglowek"><a href="magazynzmien2?sort=2">Opis</a></td>
                    <td class="naglowek"><a href="magazynzmien2?sort=3">Cena</a></td>
                    <td class="naglowek"><a href="magazynzmien2?sort=4">Ilo&#347;&#263;</a></td>
                    <td class="naglowek"><a href="magazynzmien2?sort=5">Kategoria</a></td>
                    <td class="naglowek">Zmie&#324;</td>
                </tr>
